"""
Django settings for yasana_lau project.
...
SECRET_KEY = 'django-insecure-u%mxj#pkg^*qz3$9d+x43#ydllt+sab$d&g6s^+5t)s8=p@$y)'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['www.lauprovincialcouncil.org']
...
WSGI_APPLICATION = 'yasana_lau.wsgi.application'
...
LOGOUT_REDIRECT_URL = '/'
CONTACT_EMAIL = 'admin@lau.gov.fj'
